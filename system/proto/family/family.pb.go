...
const file_family_proto_rawDesc = "" +
	"\n" +
	"\ffamily.proto\x12\x06family\"\"\n" +
	"\fGreetRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"+\n" +
	"\rGreetResponse\x12\x1a\n" +
	"\bgreeting\x18\x01 \x01(\tR\bgreeting2B\n" +
	"\bsayHallo\x126\n" +
	"\x05Greet\x12\x14.family.GreetRequest\x1a\x15.family.GreetResponse\"\x00B\x1cZ\x1asystem/proto/family;familyb\x06proto3"
...
var file_family_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_family_proto_goTypes = []any{
	(*GreetRequest)(nil),  // 0: family.GreetRequest
	(*GreetResponse)(nil), // 1: family.GreetResponse
}
var file_family_proto_depIdxs = []int32{
	0, // 0: family.sayHallo.Greet:input_type -> family.GreetRequest
	1, // 1: family.sayHallo.Greet:output_type -> family.GreetResponse
